    ...
    <div className="p-6 max-w-6xl mx-auto">
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-20 rounded-xl
          ...
          {children.length === 0 ? (
            <>
              <p className="text-sm font-medium text-[var(--foreground)]">No children registered yet</p>
              <p className="text-xs text-[var(--muted-foreground)] mt-1 text-center max-w-xs px-4">
                Children are added automatically when they&apos;re checked in for the first time.
              </p>
            </>
          ) : (
            <>
              <p className="text-sm font-medium text-[var(--foreground)]">No children match your search</p>
              <p className="text-xs text-[var(--muted-foreground)] mt-1 text-center max-w-xs px-4">
                Try adjusting the name search or class filter.
              </p>
            </>
          )}
        </div>
